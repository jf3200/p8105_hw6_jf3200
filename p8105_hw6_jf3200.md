...
```
    ...
    ##   <chr>          <dbl>     <dbl>     <dbl>     <dbl>
    ## 1 (Intercept) -6264.      99.0      -63.2  0.       
    ## 2 babysexmale   -33.1      8.77      -3.77 1.64e-  4
    ## 3 bhead         138.       3.55      38.8  1.42e-282
    ## 4 blength        81.2      2.07      39.3  1.49e-289
    ## 5 fincome         1.10     0.176      6.24 4.75e- 10
    ## 6 gaweeks        13.4      1.51       8.91 7.34e- 19
    ## 7 momage          3.77     1.18       3.18 1.46e-  3
    ## 8 ppbmi           3.42     1.36       2.51 1.20e-  2
    ## 9 smoken         -2.25     0.586     -3.84 1.27e-  4
